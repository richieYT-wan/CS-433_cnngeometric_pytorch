...
class ArgumentParser():
    ...
    def add_cnn_model_parameters(self):
        ...
        model_params.add_argument('--feature-extraction-cnn', type=str, default='vgg', help='feature extraction CNN model architecture: vgg/resnet101/wormbrain_1/wormbrain_2')
        model_params.add_argument('--feature-regression', type=str, default='base', help='feature regression : base or wormbrain')
...
### SECTION FOR OPTIONS FOR run.py ###
    ...
    def add_run_data_parameters(self):
        ...
        data_params.add_argument('--extension', type = str, default = 'jpg', help = 'Extension of the files to use, ex jpg, mp4, h5, .jpg both work.')
